# (Unofficial) Amazon Selling Partner API client (PHP) - Selling Partner API for Shipping
...
```shell
composer require bricre/amazon-selling-partner-sdk-shipping
```
...
```php
<?php
use Amz\Shipping\ResponseTypes;
